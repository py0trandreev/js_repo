...
function showMoreText(card) {
    ...
    let productNameElement = card.wrap.querySelector('.productName');
    let htmlDivElement = `<div class='desc'>${someText}</div>`;
    productNameElement.insertAdjacentHTML("afterend",htmlDivElement);
